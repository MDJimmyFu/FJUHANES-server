...
tables = ["OPDUSR.INABBEDLOG", "OPDUSR.INABBED"]

for t in tables:
    print(f"\nChecking {t} for HHISNUM {hhisnum}...")
    sql = f"SELECT * FROM {t} WHERE HHISNUM = '{hhisnum}'"
