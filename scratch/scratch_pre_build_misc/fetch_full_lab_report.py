...
hunter = ReportFetcher()
trx_num = '25279'

print(f"Fetching full details for TRX_NUM {trx_num}...")
sql = f"SELECT * FROM OPDUSR.PAT_RESULTD WHERE PRD_TRX_NUM = '{trx_num}'"
res = hunter.execute_sql(sql)

if res and "<NewDataSet>" in res:
    print("!!! FOUND FULL REPORT !!!")
    print(res[:10000]) # Print enough to capture all rows
else:
