...
print(f"Querying LABIHED for HIDNO {hidno}...")
sql = f"SELECT * FROM OPDUSR.LABIHED WHERE HIDNO = '{hidno}' ORDER BY LIHEXAMDATE DESC"
res = hunter.execute_sql(sql)

if res and "<NewDataSet>" in res:
    print("!!! FOUND LABIHED DATA !!!")
    print(res[:5000])
else:
    print("[-] No data in LABIHED.")
